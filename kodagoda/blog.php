...
<body class="aboutbg space-grotesk-thin">
    ...
    <div class="container-flex">
        <div class="container mt-5">
            <h1>Blog</h1>
            <p>Welcome to our blog! Here you'll find the latest news and updates from Flower Shop.</p>
            <div class="row">
                <?php
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo '<a href="blog_post.php?id=' . $row['id'] . '" class="btn btn-outline-info">Read More</a>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
                    }
